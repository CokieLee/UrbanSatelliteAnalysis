...
# train_dataset = datasets.MNIST(root="EuroSAT_RGB/", download=True, train=True, transform=)
...
# %%
print("y_train unique values:", torch.unique(torch.tensor(y_train)))
# print("y_train min:", min(y_train), "max:", max(y_train))
# %%
num_epochs=10
